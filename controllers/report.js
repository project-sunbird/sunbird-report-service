...
const debug = require('debug')('controllers:report');
...
const read = async (req, res, next) => {
  try {
    ...
    } else if (type !== CONSTANTS.REPORT_TYPE.PUBLIC || status !== CONSTANTS.REPORT_STATUS.LIVE) {
      return next(createError(401, CONSTANTS.MESSAGES.FORBIDDEN));
    }
...
module.exports = {
  search, create, remove, read, update, publish, retire, readWithDatasets,
};
