...
const debug = require('debug')('helpers:dataServiceHelper');
...
const fetchAndFormatExhaustDataset = async ({ req, document, user }) => {
  ...
  try {
    ...
    return [{
      dataset_id: datasetId, data: [], parameters: null, isParameterized: false,
    }];
  }
};
